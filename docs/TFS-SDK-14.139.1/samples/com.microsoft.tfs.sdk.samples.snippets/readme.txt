...
3. Run each snippet program like:
   ...
   (Windows)
   java -Dcom.microsoft.tfs.jni.native.base-directory=..\..\redist\native -classpath ..\..\redist\lib\com.microsoft.tfs.sdk-14.139.1.jar;.\bin com.microsoft.tfs.sdk.samples.snippets.SnippetClassName

   (Unix and Mac OS)
   java -Dcom.microsoft.tfs.jni.native.base-directory=../../redist/native -classpath ../../redist/lib/com.microsoft.tfs.sdk-14.139.1.jar:./bin com.microsoft.tfs.sdk.samples.snippets.SnippetClassName
