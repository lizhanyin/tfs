...
package com.github.lizhanyin.tfs.client.ui.credentials;

import com.github.lizhanyin.tfs.client.ui.credentials.internal.IdeaCredentialsManager;
 ...
 */
public class IdeaCredentialsManagerFactory {
    /**
    ...
    public static CredentialsManager getCredentialsManager(final PersistenceStoreProvider persistenceProvider) {
        ...
        /*
         * IdeaCredentialsManager uses platformCredentialsManager and IntelliJ IDEA
         * PasswordSafe for Username/Password and PAT credentials.
         */
        return new IdeaCredentialsManager(persistenceProvider);
    }

    public static CredentialsManager getCredentialsManager() {
        return new IdeaCredentialsManager(DefaultPersistenceStoreProvider.INSTANCE);
    }
}
