...
/**
 * Provides persistence for the following things using IDEA's
...
public final class TeamContextCache {
    ...
    public ProjectInfo[] getActiveTeamProjects(
        ...
        return activeProjectList.toArray(new ProjectInfo[0]);
    }
     ...
     * then trying IDEA's PropertiesComponent. If no saved memento was found,
        ...
        synchronized (cache) {
            ...
            if (memento == null) {
                try {
                    ...
                    final String mementoString = properties.getValue(preferenceName);
    ...
    /**
     * Sets the memento for the specified key into the in-memory cache and
     * IDEA's PropertiesComponent.
     * <p>
    ...
    private void setMemento(final String key, final XMLMemento memento) {
        ...
        try {
            ...
            properties.setValue(preferenceName, outputStream.toString(PREFERENCE_CHARSET));
        } catch (final Exception e) {
