...
package com.github.lizhanyin.tfs.client.ui.vc;
...
public class ExtendedItemSetHandler {
    ...
    public static Object handleItemSet(final ExtendedItem[] items, final ExtendedItemSetVisitor visitor)
        ...
        for (ExtendedItem item : items) {
             ...
             * separator character.
             */
            final String parentPath = ServerPath.getParent(item.getSourceServerItem());

            final Object parent = map.get(parentPath);

            final Object node = visitor.visit(item, parent);
             ...
             * character.
             */
            final String serverItem = item.getSourceServerItem();
