...
package com.github.lizhanyin.tfs.client.commands.vc;
...
import com.github.lizhanyin.tfs.client.util.DateHelper;
...
public class QueryItemsCommand extends TFSCommand {
    ...
    @Override
    protected IStatus doRun(final ProgressIndicator progressMonitor) throws Exception {
        progressMonitor.setText(getName());
        try {
