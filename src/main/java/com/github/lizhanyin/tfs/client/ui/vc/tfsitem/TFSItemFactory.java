...
public class TFSItemFactory {
    ...
    public static TFSItem createImplicitWithChildren(final ExtendedItem[] extendedItems, final boolean b) {
        ...
        for (ExtendedItem extendedItem : extendedItems) {
            root.addChild(getItem(extendedItem));
        }
    ...
    public static TFSItem[] getImplicitAdds(TFSRepository repository, final TFSFolder parent) {
        ...
        final List<TFSFolder> implicitAddList = new ArrayList<>();
        ...
        for (PendingChange pendingChange : pendingChanges) {
             ...
             */
            String relative = ServerPath.makeRelative(pendingChange.getServerItem(), parent.getFullPath());
        ...
        return implicitAddList.toArray(new TFSItem[0]);
    }
}