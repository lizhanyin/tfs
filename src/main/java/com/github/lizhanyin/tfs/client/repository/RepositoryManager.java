...
public class RepositoryManager {
    ...
    public final TFSRepository[] getRepositories() {
        synchronized (lock) {
            return repositoryList.toArray(new TFSRepository[0]);
        }
    }
    ...
    public final void removeRepository(final TFSRepository repository) {
        ...
        synchronized (lock) {
            ...
            if (repository.equals(defaultRepository)) {
                defaultRepository = repositoryList.isEmpty() ? null : repositoryList.getFirst();
    ...
    private static class RepositoryReplaceResults {
    ...
    private static class ExistingRepositoryReplaceResults extends RepositoryReplaceResults {
